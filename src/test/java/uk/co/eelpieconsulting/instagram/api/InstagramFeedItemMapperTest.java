...
import uk.co.eelpieconsulting.instagram.api.InstagramFeedItemMapper;
...
public class InstagramFeedItemMapperTest {
	...
	public void canExtractLocationFromGeotaggedInstagramImage() throws Exception {	
		...
		final List<FeedItem> feedItems = parseItems(json);
				
		final LatLong latLong = feedItems.get(2).getLatLong();		
	...
	public void shouldExtractUserInformationFromInstragramPosts() throws Exception {
		...
		assertEquals("km001", feedItems.get(0).getAuthor());		
	}
